...
const Skills = () => {
    return (
        <div className='pt-8 bg-[#0f172a] ' style={{backgroundImage:`url('${bg}')`,backgroundPosition:"center",backgroundSize:"cover", backgroundAttachment:"fixed"}}>
            <div className='flex justify-center align-middle'> <h1 className='inline-block text-4xl tracking-widest text-center text-white ultra-regular md:text-5xl ' style={{borderBottom:"8px solid rgb(9,244,244,1)"}}>Skills</h1></div>
            <div className='flex px-20 skills' >
                <MouseParallaxContainer globalFactorX={0.1} globalFactorY={0.1} className='flex flex-wrap justify-center gap-20 mt-14' >
                    ...
                    <MouseParallaxChild factorX={0.7} factorY={0.8}>
                        <img src={vite} alt="" className='w-16 lg:w-24'/>
                        <h1 className='text-sm text-center text-white lg:text-xl space-mono-regular'>Vite</h1>
                    </MouseParallaxChild>
                </MouseParallaxContainer>
            </div>
        </div>
