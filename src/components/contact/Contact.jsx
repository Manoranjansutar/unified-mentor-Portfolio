         ...
         <Lottie animationData={contact} style={{height:"320px"}} className='mb-5'/>
            <div className='flex flex-col'>
              <form onSubmit={handleSubmit}>
                <input type="text" placeholder='Your Name' className='w-full h-10 p-3 mb-4 rounded-md' name='name' value={formData.name} onChange={handleChange} required/>
