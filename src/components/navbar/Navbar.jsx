        ...
        <div className='sticky top-0 left-0 w-full px-4 sm:px-6 lg:px-20 py-2 z-40 bg-[#0f172a] navbar'>
            <div className='flex items-center justify-between'>
                <div className='flex flex-col'>
                    <div className='flex items-center gap-2 space-mono-regular logo'>
                ...
                {/* Desktop Menu */}
                <ul className='hidden gap-4 text-lg text-white cursor-pointer md:flex lg:text-xl menu space-mono-regular group'>
